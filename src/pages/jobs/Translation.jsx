...
// Component for Completed Projects List
    ...
    <div>
        ...
        <ul>
            {projects.map((project, index) => (
                <li key={index}>
                    {/* Display project details, you can link to a separate project page */}
                    {project.title}
                </li>
            ))}
        </ul>
...
const Translation = ({ onClose }) => {
    ...
    const handleJobSubmission = async (e) => {
        ...
        try {
            await push(ref(database, 'jobs/translation'), {
                jobTitle: jobTitle,
    ...
    return (
        <div className="flex flex-col min-w-full  overflow-auto">
            <h2 className="text-xl font-medium mb-4">Translation Service</h2>
            <div className="flex flex-col lg:flex-row ">
                <div className="w-full md:w-full lg:w-1/2 pr-4  lg:border-r border-gray-300">
                    <form onSubmit={handleJobSubmission} className="flex flex-col h-full justify-between ">
                        ...
                        <input
                            className="border-1 border-purple-500 focus:outline-purple-300 p-2 mx-2 rounded-lg h-8"
                            type="text"
                            id="jobTitle"
                            value={jobTitle}
                        ...
                        <textarea
                            className="border-1 border-purple-500 focus:outline-purple-300 mx-2 p-2 rounded-lg h-32 resize-none"
                            id="jobDescription"
                        ...
                        <input
                            className="border-1 py-5 border-purple-500 focus:outline-purple-300 px-2 mx-2 rounded-lg h-8"
                            type="number"
                            id="price"
                            value={selectedPrice}
                        ...
                        <select
                            className="border-1  border-purple-500 focus:outline-purple-300  mx-2 rounded-lg h-10"
                            id="experienceLevel"
                        ...
                        <button className="bg-purple-500 text-white rounded m-2 p-3" type="submit">Post Job</button>
                    </form>
                </div>
