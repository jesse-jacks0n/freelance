...
const DocumentConversion = ({ onClose }) => {
    ...
    const handleJobSubmission = async (e) => {
        ...
        try {
            await push(ref(database, 'jobs/documentConversion'), {
                jobTitle: jobTitle,
    ...
    return (
        <div className="flex flex-col min-w-full overflow-auto">
            <h2 className="text-xl font-medium mb-4">Doc Conversion</h2>
            <div className="flex flex-col lg:flex-row ">
                <div className="w-full md:w-full lg:w-1/2 pr-4  lg:border-r border-gray-300">
                    <form onSubmit={handleJobSubmission} className="flex flex-col h-full justify-between ">
                        ...
                        <input
                            className="border-1 border-green-500 focus:outline-green-300 p-2 mx-2 rounded-lg h-8"
                            type="text"
                            id="jobTitle"
                            value={jobTitle}
                        ...
                        <textarea
                            className="border-1 border-green-500 focus:outline-green-300 mx-2 p-2 rounded-lg h-32 resize-none"
                            id="jobDescription"
                        ...
                        <input
                            className="border-1 py-5 border-green-500 focus:outline-green-300 px-2 mx-2 rounded-lg h-8"
                            type="number"
                            id="price"
                            value={selectedPrice}
                        ...
                        <select
                            className="border-1  border-green-500 focus:outline-green-300  mx-2 rounded-lg h-10"
                            id="experienceLevel"
                        ...
                        <button className="bg-green-500 text-white rounded m-2 p-3 focus:bg-orange-400" type="submit">
                            Post Job
                        </button>
                    </form>
                </div>
