...
const LogoDesign = ({ onClose }) => {
    ...
    const [experienceLevelOptions] = useState(['Beginner', 'Intermediate', 'Expert']);
    ...
    const handleJobSubmission = async (e) => {
        ...
        try {
            // Replace 'translation' with the appropriate job category (e.g., 'logoDesign')
            await push(ref(database, 'jobs/logoDesign'), {
                jobTitle: jobTitle,
    ...
    return (
        <div className="flex flex-col min-w-full overflow-auto">
            <h2 className="text-xl font-medium mb-4">Logo Design</h2>
            <div className="flex flex-col lg:flex-row ">
                <div className="w-full md:w-full lg:w-1/2 pr-4  lg:border-r border-gray-300">
                    <form onSubmit={handleJobSubmission} className="flex flex-col h-full justify-between ">
                        ...
                        <input
                            className="border-1 py-5 border-teal-500 focus:outline-teal-300 px-2 mx-2 rounded-lg h-8"
                            type="number"
                            id="price"
                            value={selectedPrice}
                        ...
                        <select
                            className="border-1  border-teal-500 focus:outline-teal-300  mx-2 rounded-lg h-10"
                            id="experienceLevel"
                        ...
                        <button className="bg-teal-500 text-white rounded m-2 p-3" type="submit">Post Job</button>
                    </form>
                </div>
